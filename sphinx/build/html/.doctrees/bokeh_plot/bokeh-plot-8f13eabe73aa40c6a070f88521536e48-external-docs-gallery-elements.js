(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("db0e808c-71b7-4728-84ad-f39a0faad7b3");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid 'db0e808c-71b7-4728-84ad-f39a0faad7b3' but no matching script tag was found. ")
        return false;
      }
