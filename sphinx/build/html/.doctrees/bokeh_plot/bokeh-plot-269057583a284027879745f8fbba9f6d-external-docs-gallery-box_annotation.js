(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("0afe2231-fbd7-440b-9242-463784af7ddc");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '0afe2231-fbd7-440b-9242-463784af7ddc' but no matching script tag was found. ")
        return false;
      }
