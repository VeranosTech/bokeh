(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("f6a061d7-d62f-498b-83a2-e8c22cf7c4a3");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid 'f6a061d7-d62f-498b-83a2-e8c22cf7c4a3' but no matching script tag was found. ")
        return false;
      }
