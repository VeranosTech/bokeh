(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("2b11e2a5-c882-447f-b8cf-b504b18c4a12");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '2b11e2a5-c882-447f-b8cf-b504b18c4a12' but no matching script tag was found. ")
        return false;
      }
