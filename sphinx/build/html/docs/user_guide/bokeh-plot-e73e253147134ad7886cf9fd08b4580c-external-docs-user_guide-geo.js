(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("d3d1e930-d29f-43a8-a308-eeb4fb234f7c");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid 'd3d1e930-d29f-43a8-a308-eeb4fb234f7c' but no matching script tag was found. ")
        return false;
      }
