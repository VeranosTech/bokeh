(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("05b20ed0-4a5d-4fea-ac5f-99651237a2da");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid '05b20ed0-4a5d-4fea-ac5f-99651237a2da' but no matching script tag was found. ")
        return false;
      }
        ...
        function(Bokeh) {
          ...
          ({
            "custom/main": function(require, module, exports) {
              var models = {
                "Surface3d": require("custom/bk_script_22543.surface3d").Surface3d
              };
              require("base").register_models(models);
              module.exports = models;
            },
            "custom/bk_script_22543.surface3d": function(require, module, exports) {
          "use strict";
          ...
          var Surface3dView = /** @class */ (function (_super) {
              __extends(Surface3dView, _super);
              function Surface3dView() {
                  return _super !== null && _super.apply(this, arguments) || this;
              }
              Surface3dView.prototype.initialize = function () {
                  var _this = this;
                  _super.prototype.initialize.call(this);
                  var url = "https://cdnjs.cloudflare.com/ajax/libs/vis/4.16.1/vis.min.js";
              ...
              Surface3dView.prototype._init = function () {
                  ...
                  this.connect(this.model.data_source.change, function () {
                      _this._graph.setData(_this.get_data());
                  });
              };
              ...
              Object.defineProperty(Surface3dView.prototype, "child_models", {
                  get: function () {
                      return [];
                  },
                  enumerable: true,
              ...
              Surface3dView.prototype._update_layout = function () {
          ...
          var Surface3d = /** @class */ (function (_super) {
              ...
              function Surface3d(attrs) {
                  return _super.call(this, attrs) || this;
              }
              Surface3d.initClass = function () {
