(function() {
  var fn = function() {
    ...
    (function(root) {
      ...
      };var element = document.getElementById("e098e86d-e85e-4b0f-ba74-4e6bc597bdee");
      if (element == null) {
        console.error("Bokeh: ERROR: autoload.js configured with elementid 'e098e86d-e85e-4b0f-ba74-4e6bc597bdee' but no matching script tag was found. ")
        return false;
      }
